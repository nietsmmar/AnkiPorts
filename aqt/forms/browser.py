...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.actionClear_Flag = QtWidgets.QAction(Dialog)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.actionClear_Flag.setText(_("Clear Flag"))
        self.actionClear_Flag.setShortcut(_("Ctrl+0"))
        self.actionRed_Flag.setText(_("Red Flag"))
        self.actionRed_Flag.setShortcut(_("Ctrl+1"))
        self.actionPurple_Flag.setText(_("Purple Flag"))
        self.actionPurple_Flag.setShortcut(_("Ctrl+2"))
