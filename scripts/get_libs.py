...
#
# copyright 2018 by Tim Sueberkrueb
...
target_directory = 'install/lib/arm-linux-gnueabihf'
...
if __name__ == "__main__":
    if  len(sys.argv) < 4:
        raise Exception("Usage: {0} <ARCH> <ARCH_TRIPLET> <INSTALL_DIR> dep1 dep2 ...", sys.argv[0])
    
    arch_list = ["armhf"]
    multiarch_list = [sys.argv[1]]
